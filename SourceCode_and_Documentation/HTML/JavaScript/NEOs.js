...
function sentryInput() {
    ...
    var url = "https://api.nasa.gov/neo/rest/v1/feed?" + `start_date=${date}&end_date=${date}&detailed=true` + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG" 
...
function hazardInput() {
    ...
    //Get API data
    var request = new XMLHttpRequest()
    var url = "https://api.nasa.gov/neo/rest/v1/feed?" + `start_date=${date}&detailed=true` + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG" 
    request.open('GET', url, true)
    request.onload = function () {
        // Begin accessing JSON data here
        var data = JSON.parse(this.response)
...
function get_API_data(date, end) {
    var request = new XMLHttpRequest()
    var url = `https://api.nasa.gov/neo/rest/v1/feed?start_date=${date}&end_date=${end}&detailed=true&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG`
    request.open('GET', url, true)
    request.onload = function () {
        // Begin accessing JSON data here
        var data = JSON.parse(this.response)
...
function neoClicked() {
    ...
    var request = new XMLHttpRequest()
    var url = "https://api.nasa.gov/neo/rest/v1/neo/" + id["health"] + "?" + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG" 
    request.open('GET', url, true)
    request.onload = function () {
        // Begin accessing JSON data here
        var data = JSON.parse(this.response)
