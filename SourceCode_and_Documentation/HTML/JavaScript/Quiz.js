...
(function(){
    ...
    const myQuestions = [
      ...
      {
        question: "What sparks intrest into study NEOs from scientest?",
        answers: {
          a: "NEOs are existing debris from the formation of a solar system",
        ...
        {
            question: "What perecent did the astreoid of comet that struck near Mexico 65 million years ago, wipe out living organsims?",
            answers: {
            a: "15.21%",
            b: "48%",
            c: "100%",
        ...
        {
            question: "What can be carried out to erdicate the risk of NEOs if impose a risk?",
            answers: {
