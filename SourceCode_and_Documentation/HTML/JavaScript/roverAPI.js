...
var url = "https://api.nasa.gov/mars-photos/api/v1/manifests/curiosity?api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG"
...
request.onload = function () {
    for (const camera of ["FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"]){
        ...
        var request = new XMLHttpRequest()
        var url = 'https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?camera='+ camera +'&'+ "earth_date=" + date + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG";
        request.open('GET', url, true)
        request.onload = function () {
            var i = 0;
            var data = JSON.parse(this.response)
...
function earthDateInput() {
    ...
    for (const camera of ["FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"]){
        ...
        var request = new XMLHttpRequest()
        var url = 'https://api.nasa.gov/mars-photos/api/v1/rovers/'+ rover +'/photos?camera='+ camera +'&'+ "earth_date=" + earthDate + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG";
        request.open('GET', url, true)
...
function solInput() {
    ...
    for (const camera of ["FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"]){
        ...
        var request = new XMLHttpRequest()
        var url = `https://api.nasa.gov/mars-photos/api/v1/rovers/${rover}/photos?sol=${sol}&camera=${camera}&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG`;
        request.open('GET', url, true)
...
function camInput() {
    ...
    var request = new XMLHttpRequest()
    var url = `https://api.nasa.gov/mars-photos/api/v1/rovers/${rover}/photos?earth_date=${camDate}&camera=${camera}&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG`;
    request.open('GET', url, true)
...
//spirit
var request = new XMLHttpRequest()
var url = "https://api.nasa.gov/mars-photos/api/v1/manifests/spirit?api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG"
...
request.onload = function () {
    for (const camera of ["FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"]){
        ...
        var date = data["photo_manifest"]["max_date"]
        var request = new XMLHttpRequest()
        var url = 'https://api.nasa.gov/mars-photos/api/v1/rovers/spirit/photos?camera='+ camera + '&' + "earth_date=" + date + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG";
        request.open('GET', url, true)
        request.onload = function () {
            var i = 0;
            var data = JSON.parse(this.response)
...
//opportunity
var request = new XMLHttpRequest()
var url = "https://api.nasa.gov/mars-photos/api/v1/manifests/opportunity?api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG"
...
request.onload = function () {
    for (const camera of ["FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"]){      
        ...
        var date = data["photo_manifest"]["max_date"]
        var request = new XMLHttpRequest()
        var url = 'https://api.nasa.gov/mars-photos/api/v1/rovers/opportunity/photos?camera=' +camera+ '&' +"earth_date=" + date + "&api_key=yGIR0aJmk0heKdgXmZrFt8jaZRDO0DySxVxMfCxG";
        request.open('GET', url, true)
        request.onload = function () {
            var i = 0;
            var data = JSON.parse(this.response)
